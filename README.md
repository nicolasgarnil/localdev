...
- `AGENTS.md` - global Claude Code guidelines applied across all projects; `install.sh` links it to `~/.claude/AGENTS.md`, where `~/.claude/CLAUDE.md` imports it via `@AGENTS.md`.
